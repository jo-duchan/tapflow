...
- iOS: `.app.zip` or `.tar.gz`/`.tgz` — a simulator build. Build `.app.zip` [from the command line](https://developer.apple.com/library/archive/technotes/tn2339/_index.html), or upload a `.tar.gz`/`.tgz` simulator build as-is.
- Android: `.apk`
...
For CI/CD uploads — automatic builds from your pipeline — see [Build Distribution](/operate/ci-distribution).
