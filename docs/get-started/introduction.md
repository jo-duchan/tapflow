...
- **MCP Server** — exposes tapflow as a tool for LLM agents. Claude Code and other MCP-compatible agents can control simulators directly. → [MCP Server guide](/automation/mcp-server)
