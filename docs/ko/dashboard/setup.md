...
2. 팀원의 이메일과 역할을 선택합니다:
   ...
   - **Viewer** — 읽기 전용입니다. 빌드를 보고, QA 세션에서 시뮬레이터나 에뮬레이터로 테스트하고, 댓글을 남길 수 있습니다. 빌드·앱·웹훅은 바꿀 수 없습니다.

   댓글 작성과 세션 시작은 역할과 관계없이 로그인한 팀원 누구나 할 수 있습니다. 역할을 바꾸면 팀원이 다시 로그인하지 않아도 바로 적용됩니다.
