...
| 디바이스 카드 | 사용 가능한 시뮬레이터를 보여줍니다. **●** = 부팅됨, **○** = 사용 가능. 클릭하면 세션이 시작됩니다. |

## QA 세션

**경로**: `/app-center/build`

시뮬레이터 전체 화면 뷰입니다. App Center에서 디바이스 카드를 클릭하면 열립니다.
...
::: info 녹화 보관 기간
녹화 파일은 업로드 후 **72시간** 동안 보관됩니다. 장기 보관이 필요하면 다운로드해 별도로 저장하세요.
:::
...
- **비밀번호 재설정 발송** — 특정 멤버에게 비밀번호 재설정 이메일을 발송합니다.
