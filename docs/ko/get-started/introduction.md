...
두 방식의 화질·지연감이 다를 수 있습니다. 해상도와 디코더는 각 시청자의 연결에 따라 자동으로 조정됩니다 — [스트림 품질](/ko/operate/streaming-quality) 참고.
:::
...
- **MCP Server** — tapflow를 LLM 에이전트 도구로 제공합니다. Claude Code 등에서 시뮬레이터를 직접 조작할 수 있습니다. → [MCP 서버 가이드](/ko/automation/mcp-server)
