...
- **오디오 권한**: 시뮬레이터 오디오 캡처에 필요한 권한을 미리 요청합니다. 자세한 내용은 [오디오](/ko/testing/audio)를 참고하세요.
- **네트워크 필터**: 네트워크 제어에 쓰는 필터를 설치합니다. 자세한 내용은 [네트워크 제어](/ko/testing/network-control)를 참고하세요.
