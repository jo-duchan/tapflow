...
| 2.6 | **freeze 단축** = iOS 비트레이트 캡(A) + IDR-on-drop(B) | freeze의 ①혼잡 + ②IDR 대기 둘 다 축소 | 🔄 **구현** — A: VT AverageBitRate/DataRateLimits 8Mbps 캡(env). B: relay→agent `stream:request-idr`→swift stdin `0x01` force IDR. LAN 재현 검증 남음 |
