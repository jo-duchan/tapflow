...
**Won't Fix**: WebRTC DataChannel 터치 전송은 Phase 3에서 검토했으나 보류됐다. `@roamhq/wrtc`에서 ~236KB 이상 메시지 시 채널이 조용히 닫히는 불안정 문제, relay-intermediary 구조에서 P2P 이점 없음 등의 이유로 제외됐다.
